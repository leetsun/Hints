...
if challenge and uid and publickey:
  privatekey = hmac_md5(publickey,challenge)
...
routing_token = 'SetTelnetSettings'
soapaction = 'http://purenetworks.com/HNAP1/{}'.format(routing_token)
header['SOAPACTION'] = soapaction
header['Cookie'] = cookie
header['HNAP_AUTH'] = hnap_auth(privatekey,soapaction)

param = {routing_token: ""}
param = { "SetTelnetSettings": { "telnet_enabled": "1"} }
